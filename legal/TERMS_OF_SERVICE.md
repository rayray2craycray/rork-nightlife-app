...
- You will provide accurate date of birth information

We reserve the right to request proof of age at any time. Accounts of users found to be under 21 will be terminated immediately without notice.

### 2.2 Geographic Restrictions

The App is currently available only in the United States. By using the App, you represent that you are located in the U.S. or are visiting temporarily.
...
- Participate in challenges and social features
- Purchase event tickets
- Engage with venue communities
...
- Share content depicting illegal activity
- Purchase or sell illegal items or services
...
- Share content you don't have the rights to
- Infringe on intellectual property rights
- Post spam or misleading information

**Platform Abuse:**
- Create fake accounts or bot accounts
- Use automated systems to access the App
- Attempt to hack, breach, or bypass security measures
...
- Create fake venues or events
- Manipulate challenges or rewards systems
- Chargeback fraud

**Minors:**
- Encourage or enable minors (under 21) to use the App
- Share content depicting minors in nightlife settings

### 3.3 Venue-Specific Rules

When using venue-specific features (lobbies, servers), you agree to:
- Follow venue-specific rules and codes of conduct
- Respect venue owners' and managers' decisions
- Not impersonate venue staff
- Not post false information about venues
...
You retain ownership of content you post ("User Content"), including:
- Photos and videos
...
**This license ends when you delete your content or account, except:**
- Content shared by other users (e.g., if someone saved your photo)
- Content needed for legal compliance or safety reasons

### 4.3 Content Standards

All User Content must:
- Be appropriate for a mature (21+) audience
- Comply with all laws and regulations
- Not violate others' rights (privacy, intellectual property, etc.)
...
- Remove content for any reason or no reason
- Use automated tools to detect violations

**We are not obligated to moderate content and are not responsible for User Content.**
...
### 5.4 Check-In and Entry

- Tickets are checked in using QR codes
- Do not share your QR code with others
- Screenshots or photos of QR codes are not valid (live QR code required)
- Venues may refuse entry for any reason
- We are not responsible for venue entry decisions
...
Payments are processed by third-party payment processors (Stripe). By making a purchase, you agree to the payment processor's terms.

### 6.2 Fees

- Ticket prices are set by venues and may include service fees
...
### 7.1 Challenge Participation

- Challenges are optional and for entertainment purposes
- Rules for each challenge are provided in the challenge description
- We reserve the right to disqualify participants for cheating or violations
- Challenges may be cancelled or modified at any time
...
Any attempt to manipulate challenges or rewards systems may result in:
...
You may delete your account at any time in app settings. Upon deletion:
- Your profile and User Content will be removed within 30 days
- You will lose access to all account features
- Ticket purchases and transactions are not affected
...
- Illegal activity
- Fraud or abuse
- Inactivity (accounts inactive for 2+ years)
- Risk to our users or the platform
- Any reason or no reason

### 8.3 Effect of Termination

Upon termination:
- You lose all access to your account and User Content
- You may not create a new account without our permission
- Provisions of these Terms that should survive will remain in effect (e.g., liability, indemnification)
...
The App may integrate with third-party services (e.g., Instagram, payment processors, mapping services). Your use of these services is governed by their terms and privacy policies.

**We are not responsible for third-party services and do not endorse or guarantee their availability or accuracy.**
...
### 12.2 No Liability for User Content

**WE ARE NOT RESPONSIBLE FOR USER CONTENT, INCLUDING:**
- Offensive, inaccurate, or illegal content
- Content that violates your rights
- Interactions between users

### 12.3 No Liability for Venue Actions

**WE ARE NOT RESPONSIBLE FOR:**
- Venue operations, safety, or quality
- Event cancellations or changes
- Venue entry decisions
...
- Held in [Your State/City]
- Each party pays their own costs and fees
- For claims under $10,000, we will reimburse your arbitration fees if you prevail

**Exceptions:** You may sue in small claims court if your claim qualifies.
...
- Combine your claim with others

**If this class action waiver is found invalid, the arbitration agreement will not apply.**
...
You may not transfer these Terms or your account. We may transfer our rights and obligations without your consent.

### 15.6 Force Majeure

We are not liable for delays or failures due to events beyond our reasonable control (e.g., natural disasters, wars, pandemics, government actions).
...
You may not use the App if you are prohibited from receiving U.S. exports under U.S. law.
...
**What you can do:**
- Use the app to discover nightlife, connect with friends, and share content
- Buy event tickets and participate in challenges

**What you can't do:**
- Post illegal, harmful, or offensive content
- Harass other users or violate their rights
- Use the app if you're under 21

**Our rights:**
- We can remove content or ban users for violations
- We can change these Terms at any time
- We're not responsible for user actions or venue issues
